  ...
  const steps = [
    {
      ...
      description: 'Submit your application. We verify your driving record, insurance, and background. The process takes minutes, powered by AI—but our standards are high.',
      icon: (
